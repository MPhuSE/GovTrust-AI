  ...
  return (
    <CitizenLayout>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10 animate-fade-in">
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 text-sm font-semibold text-emerald-700 mb-6 bg-gray-50 w-max px-3 py-1.5 rounded-lg border border-teal-600">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-teal-700 mb-3 tracking-tight">Kết Quả Phân Tích AI</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-md p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col items-center relative overflow-hidden">
            ...
            {/* Continue section */}
            <div className="bg-white rounded-md p-6 sm:p-8 border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.02)] relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-gray-500"></div>
              <h3 className="font-bold text-teal-700 text-lg mb-3">Chuyển sang bước tiếp theo</h3>
              <p className="text-sm font-medium text-gray-500 mb-6 leading-relaxed">
                Hệ thống đã chuẩn bị sẵn biểu mẫu điện tử và tự động điền các thông tin hợp lệ từ giấy tờ của bạn.
              </p>
              <button
                className="w-full px-6 py-4 rounded font-bold bg-teal-700 text-white hover:bg-teal-800 transition-all shadow-md flex items-center justify-center gap-2"
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="bg-white rounded-md p-6 sm:p-8 border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.02)]">
              <h2 className="text-xl font-bold text-teal-700 mb-6 pb-4 border-b border-gray-100">Chi tiết đối soát thông tin</h2>
              ...
              {missing.length > 0 && (
                <div className="mb-6">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-amber-50 rounded flex items-center justify-center border border-amber-100 group-hover:bg-amber-100 transition-colors shrink-0">
                        <span className="text-amber-500 text-lg">⚠️</span>
                      </div>
                      <div>
                        <p className="font-bold text-teal-700">Thiếu thông tin hoặc giấy tờ</p>
                  ...
                  {expandedSections.missing && (
                    <div className="mt-4 ml-14 space-y-3 animate-slide-up">
                      {missing.map((item, i) => (
                        <div key={i} className="bg-amber-50/50 border border-amber-100/60 rounded p-4 text-sm font-medium text-amber-800 relative overflow-hidden">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 border-t border-gray-100 pt-8">
          ...
          <button
            className="px-6 py-4 rounded font-bold bg-teal-700 text-white hover:bg-teal-800 transition-all flex-[2] text-center shadow-md flex items-center justify-center gap-2"
            onClick={() => router.push(`/smartform/${sessionId}`)}
          >
