        ...
        {data && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <StatCard
              ...
              change={data.totalSessionsChange || `Trong ${days} ngày qua`}
              changeType="neutral"
            ...
            <StatCard
              ...
              change={data.avgScoreChange || `${data.totalSessions || 0} hồ sơ đã chấm điểm`}
              changeType={Math.round(data.avgScore || 0) >= 60 ? 'up' : 'down'}
            ...
            <StatCard
              ...
              change={data.passRateChange || 'Hồ sơ đạt ≥ 60 điểm'}
              changeType={(data.passRate || 0) >= 50 ? 'up' : 'down'}
